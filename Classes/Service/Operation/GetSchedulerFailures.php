...
namespace Caretaker\CaretakerInstance\Service\Operation;
 ...
 */
class GetSchedulerFailures implements IOperation, SingletonInterface
{
    public function execute($parameter = array()): OperationResult
    {
        $results = array();
        ...
        return new OperationResult(empty($results), $results);
    }
}
